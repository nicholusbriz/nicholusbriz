      ...
      <section className="relative z-10 px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="mb-2 text-sm font-medium uppercase tracking-[0.2em] text-[#2fe92b]">Portfolio</p>
            <h2 className="text-3xl font-bold text-white">Full Stack Software Engineer Portfolio Video</h2>
          </motion.div>
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="relative overflow-hidden rounded-2xl border border-[#26272d] bg-[#0f0f0f] shadow-[0_0_60px_rgba(47,233,43,0.08)]"
          >
            <video
              ref={videoRef}
              src="/Full Stack Software Engineer Portfolio Video.mp4"
              autoPlay
              muted={isMuted}
              loop
              playsInline
